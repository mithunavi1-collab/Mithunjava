...
showStudent("Deepan", 19, "BCA");
showStudent("Harshini", 20, "BBA");
showStudent("Madhan", 21, "B.Sc Computer Science");
...
showEmployee("Mohan", "Project Manager");
showEmployee("Lakshaya", "UI Designer");
